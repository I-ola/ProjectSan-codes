...
public class PlayerController : MonoBehaviour
{
    ...
    private void OptionsKeyPressed()
    {
        optionsAction.performed += OptionsAction_performed;
        optionsAction.canceled += OptionsAction_canceled;
    }
    ...
    private void OptionsAction_canceled(InputAction.CallbackContext obj)
    {
  
    }

    private void OptionsAction_performed(InputAction.CallbackContext obj)
    {
    ...
    private void AimAction_performed(InputAction.CallbackContext obj)
    {
        ...
        if (aimingAndEquiping.GetActiveWeaponList() != null && !player.isDead)
        {
            aiming = true;
            AImIn();
        }
